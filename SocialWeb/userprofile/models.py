...
class Profile(models.Model):
    ...
    follower = models.ManyToManyField(User,null = True, blank = True,related_name='%(class)s_follower')
    follow = models.ManyToManyField(User,null = True, blank = True,related_name='%(class)s_follow')
